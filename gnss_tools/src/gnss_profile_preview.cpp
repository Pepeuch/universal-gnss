...
{
  std::cout << "Usage: " << program_name << " [--json] [--verbose] [--persistent]"
            ...
            << "  " << program_name << " unicore rover_high_precision --model UM960\n"
            << "  " << program_name
            << " unicore rover_high_precision --model UM982 --signal-profile minimal\n"
