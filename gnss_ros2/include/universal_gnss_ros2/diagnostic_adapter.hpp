...
ToDiagnosticStatusMessage(const universal_gnss::GnssDiagnosticEvent& event,
                          const std::string& name_prefix = "universal_gnss",
                          const std::string& hardware_id = "");

diagnostic_msgs::msg::DiagnosticStatus
ToHealthDiagnosticStatusMessage(const universal_gnss::GnssHealthSummary& summary,
                                const std::string& name = "universal_gnss/summary",
                                const std::string& hardware_id = "");

diagnostic_msgs::msg::DiagnosticArray
ToDiagnosticArrayMessage(const universal_gnss::GnssHealthSummary& summary,
                         const std::string& name_prefix = "universal_gnss",
                         const std::string& hardware_id = "");
